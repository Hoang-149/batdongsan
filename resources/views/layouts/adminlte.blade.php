                ...
                $.getJSON(`/api/phuong/${idtinh}`).done(function(data_phuong) {
                    if (data_phuong.error == false) {
                        ...
                        $.each(data_phuong.data, function(key_phuong, val_phuong) {
                            $("#phuong").append('<option value="' + val_phuong.code +
                                '" data-name="' +
                                val_phuong.name + '">' + val_phuong.name + '</option>'
                            );
                        });
                    }
                    resolve();
            ...
            $.getJSON('/api/tinh', function(data_tinh) {
                if (data_tinh.error == false) {
                    $.each(data_tinh.data, function(key_tinh, val_tinh) {
                        $("#tinh").append('<option value="' + val_tinh.code + '" data-name="' +
                            val_tinh.name + '">' + val_tinh
                            .name + '</option>');
                    });
                    ...
                    $("#tinh").on('change', function() {
                        ...
                        $('#phuong_name').val('');
                        $.getJSON(`/api/phuong/${idtinh}`).done(function(
                            data_phuong) {
                            if (data_phuong.error == false) {
                                $("#phuong").html(
                    ...
                    if (window.locationDefault) {
                        setLocationDefault(window.locationDefault.tinh, window.locationDefault.phuong);
                    }
                }
            });
