                ...
                <div class="flex flex-col lg:flex-row gap-8 lg:gap-12">
                    ...
                    <div class="flex items-center gap-3">
                        ...
                        <div>
                            ...
                            <p class="font-semibold text-gray-800">1900 1881</p>
                        </div>
                    </div>
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8">
                ...
                <div class="lg:col-span-2">
                    ...
                    <div class="mt-8 flex items-center gap-4">
                        ...
                        <div class="flex flex-col gap-2">
                            <div class="flex items-center gap-2 bg-gray-800 text-white px-3 py-1 rounded text-xs">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        ...
                        <li><a href="#" class="hover:text-red-500 transition-colors">Báo giá và hỗ trợ</a></li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Câu hỏi thường gặp</a></li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Góp ý báo lỗi</a></li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Sitemap</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm text-gray-600">
                        <li><a href="#" class="hover:text-red-500 transition-colors">Quy định đăng tin</a></li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Quy chế hoạt động</a></li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Điều khoản thỏa thuận</a>
                        </li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Chính sách bảo mật</a></li>
                        <li><a href="#" class="hover:text-red-500 transition-colors">Giải quyết khiếu nại</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <div class="flex">
                        <input type="email" placeholder="Nhập email của bạn"
                            class="flex-1 px-3 py-2 border border-gray-300 rounded-l-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent">
                        <button class="bg-red-500 hover:bg-red-600 text-white px-4 py-2 rounded-r-lg transition-colors">
                    ...
                    <div class="mt-6">
                        ...
                        <div class="relative">
                            <select
                                class="w-full px-3 py-2 border border-gray-300 rounded-lg text-sm focus:outline-none focus:ring-2 focus:ring-red-500 focus:border-transparent appearance-none bg-white">
